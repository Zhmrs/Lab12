...
class View:
    ...
    def load_interface(self):
        ...
        # TODO
        self.pulsante_cammimo_minimo = ft.ElevatedButton("Cammino minimo", width=200,
                                                 on_click=self.controller.handle_cerca_cammino if self.controller else None)
